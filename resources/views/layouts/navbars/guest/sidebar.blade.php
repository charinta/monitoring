<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="card">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link {{ Request::is('handle-issue') ? 'active' : '' }}" href="{{ url('handle-issue') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Handle Issue</span>
                </a>
            </li>
            <li class="nav-item mt-2">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link {{ Request::is('problem-issue') ? 'active' : '' }}"
                    href="{{ url('problem-issue') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Problem Issue</span>
                </a>
            </li>
</aside>
